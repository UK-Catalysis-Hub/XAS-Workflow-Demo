...
def single_file_task(a_file, gds_parms_f, sel_paths_f, out_pattern):
    print(a_file, gds_parms_f, sel_paths_f, out_pattern)
    return
...
def read_ini(ini_file_path):
    try:
        ...
        print("provide a valid ini file (including path)")
    return crystal_files, gds_parms_f, sel_paths_f, fit_vars
...
if __name__ == '__main__':
    ...
    print ("Path: ", cf_path)
    # read ini values
    crystal_f_path = Path(cf_path) 
    print( crystal_f_path.parent, crystal_f_path.name) 
    crystal_files = get_files_list(crystal_f_path.parent, crystal_f_path.name)    
    #crystal_files, _, _, _ = read_ini(ini_file) 
    print(crystal_files)
    ...
    # run feff once
    # it will output to filename_feff
    feff_runner.run_feff(crystal_files)
