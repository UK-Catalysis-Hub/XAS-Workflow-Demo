...
def make_subplot(a_subplt, group1, group2, xlims):
...
# compare LCF plots
def compare_lcf_plot(lcf_1, lcf_2, lcf_3, x_limits = [29190, 29230]):
    fig, axes = plt.subplots(1,3, constrained_layout=True)
    axes[0] = make_subplot(axes[0], lcf_1[0], lcf_1[1], x_limits)
    axes[1] = make_subplot(axes[1], lcf_2[0], lcf_2[1], x_limits)
    axes[2] = make_subplot(axes[2], lcf_3[0], lcf_3[1], x_limits)
    return fig
